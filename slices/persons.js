...
import {
  REQUEST_STATUS_INITIAL, REQUEST_STATUS_LOADING, REQUEST_STATUS_LOADED, REQUEST_STATUS_ERROR,
} from './constants'

const VALID_REQUEST_STATUSES = [REQUEST_STATUS_INITIAL, REQUEST_STATUS_LOADING, REQUEST_STATUS_LOADED, REQUEST_STATUS_ERROR]

const initialPersonsSlice = global?.__NEXT_DATA__?.props?.pageProps?.personsSlice

const initialState = {
  person: initialPersonsSlice?.person ?? {},
  personRequest: initialPersonsSlice?.personRequest ?? {
